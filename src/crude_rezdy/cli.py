...
product_app = typer.Typer(help="Rezdy products — list, get, create, update, delete, image-add, image-remove, pickups.")
availability_app = typer.Typer(help="Rezdy availability (sessions) — list, create, update, delete, batch.")
booking_app = typer.Typer(help="Rezdy bookings — list, cancellations, get, quote, create, update, cancel.")
customer_app = typer.Typer(help="Rezdy customers — list, get, create, delete.")
extra_app = typer.Typer(help="Rezdy extras (add-ons) — list, get, create, update, delete.")
pickup_app = typer.Typer(help="Rezdy pickup lists — list, get, create, update, delete.")
category_app = typer.Typer(help="Rezdy categories (and their product membership) — list, get, products, add-product, remove-product.")
rate_app = typer.Typer(help="Rezdy rates (and their product membership) — list, get, add-product, remove-product.")
resource_app = typer.Typer(help="Rezdy resources (and their session assignment) — list, sessions, for-session, add-session, remove-session.")
manifest_app = typer.Typer(help="Rezdy manifest / check-in — order-status, order-set, order-remove, session-status, session-set, session-remove.")
voucher_app = typer.Typer(help="Rezdy vouchers (read-only) — list, get.")
company_app = typer.Typer(help="Rezdy company (read-only) — get, find.")
