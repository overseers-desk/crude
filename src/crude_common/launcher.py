...
commands (crude-atdw, crude-skal, crude-rezdy, crude-deputy, crude-sonas, crude-xero) and the shared flags;
...
app = typer.Typer(
    help="crude — index of the per-site CLIs (crude-atdw, crude-skal, crude-rezdy, crude-deputy, crude-sonas, crude-xero).",
)
