...
commands (crude-atdw, crude-skal, crude-rezdy, crude-deputy, crude-sonas, crude-xero, crude-airwallex, crude-clover, crude-meta) and the shared flags;
...
app = typer.Typer(
    help="crude — index of the per-site CLIs (crude-atdw, crude-skal, crude-rezdy, crude-deputy, crude-sonas, crude-xero, crude-airwallex, crude-clover, crude-meta).",
)
...
SITES = [
    ...
    ("crude-meta", "Facebook Pages and Instagram (graph.facebook.com)"),
]
