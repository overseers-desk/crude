...
# Install: brew tap SmartLayer/crude https://github.com/SmartLayer/crude && brew install crude
...
class Crude < Formula
  ...
  url "https://github.com/SmartLayer/crude/archive/refs/tags/v1.2.0.tar.gz"
  sha256 "df2b524be88866fe0519299aafa569efb50adcb86c393fada3cf64349430fb6c"
  license "MIT"
  ...
  def install
    ...
    if OS.mac?
      ...
      %w[crude crude-atdw crude-skal crude-rezdy crude-deputy crude-sonas crude-xero].each do |exe|
